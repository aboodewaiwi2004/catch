...
{
  const auto & item = *reinterpret_cast<const turtlesim_interfaces::msg::Turtle *>(
    get_const_function__TurtleArray__turtles(untyped_member, index));
  auto & value = *reinterpret_cast<turtlesim_interfaces::msg::Turtle *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<turtlesim_interfaces::msg::Turtle *>(
    get_function__TurtleArray__turtles(untyped_member, index));
  const auto & value = *reinterpret_cast<const turtlesim_interfaces::msg::Turtle *>(untyped_value);
  item = value;
}
