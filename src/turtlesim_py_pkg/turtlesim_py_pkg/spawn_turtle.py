...
class SpawnTurtleNode(Node):
    ...
    def spawn_turtle(self):
         ...
         self.call_spwan_turtle_server(x, y, theta, turtle_name)

    def call_spwan_turtle_server(self, x, y, theta, turtle_name):
        ...
        future.add_done_callback(partial(self.callback_call_spwan_turtle_server, x=x, y=y, theta=theta, turtle_name=turtle_name))
  
    def callback_call_spwan_turtle_server(self, future, x, y, theta, turtle_name):
             try:
